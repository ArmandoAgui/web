...
class Report extends FPDF
{
    ...
    */
    public function startReport($title)
    {
        ...
        if (isset($_SESSION['id_empleado'])) {
            ...
            $this->setTitle('Reporte - Senga Store', true);
    ...
    */
    public function header()
    {
        ...
        $this->image('../../images/logo.png', 15, 15, 75, 25);
        // Se ubica el título.
        $this->setFont('Arial', 'B', 15);
        $this->setTextColor(255, 87, 87);
        $this->cell(186, 10, utf8_decode($this->title), 0, 1, 'R');
        $this->ln(4);
        // Se ubica la fecha y hora del servidor.
        $this->setFont('Arial', '', 10);
        $this->setTextColor(255);
        $this->cell(116);
        $this->SetFillColor(255, 87, 87);
        $this->cell(70, 10, 'Fecha/Hora: '.date('d-m-Y H:i:s'), 0, 1, 'C', 1);
        // Se agrega un salto de línea para mostrar el contenido principal del documento.
        $this->ln(4);
        $this->setTextColor(50);
        $this->SetDrawColor(255, 87, 87);
        $this->setFont('Arial', '', 11);
        $this->cell(116);
        $this->cell(18, 10, utf8_decode("Usuario: "), 'B', 0);
        $this->setFont('Arial', 'B', 12);
        $this->setTextColor(255, 87, 87);
        $this->cell(52, 10, utf8_decode($_SESSION['usuario_empleado']), 'B', 1);
        $this->ln(10);
    }
