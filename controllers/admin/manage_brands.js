...
const API_MARCA = SERVER + 'admin/marca.php?action=';
        ...
        <article class="row product mb-4">
                        <div class="info">
                            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between product-text">
                                <img class="img align-self-center align-self-md-start" src="../../resources/img/admin_icons/brand2.png" width="90px" alt="">
                                <div class="w-50 ms-5">
                                    <h5 class="mt-4 mt-md-0">${row.marca}</h5>
                                </div>
                                <div class="w-50">
                                    <h5>Estado</h5>
                                    <h6>${row.estado}</h6>
                        ...
                        <div class="my-auto options">
                            ...
                            data-bs-toggle="modal" data-bs-target="#crudModal" id="edit" onclick= "openUpdate(${row.id_marca})">
                                Editar
                            ...
                            data-bs-toggle="modal" data-bs-target="#confirmModal" id="delete" onclick="openDelete(${row.id_marca})">
                                Eliminar
...
document.getElementById('search').addEventListener('input', function() {
    ...
    searchRows(API_MARCA, 'searchForm');
});
...
function openCreate() {
    ...
    document.getElementById("modalTitle").innerHTML = 'Agregar Marca';
}
...
function openUpdate(id) {
    ...
    document.getElementById("modalTitle").innerHTML = 'Actualizar Marca';
...
document.getElementById('modalForm').addEventListener('submit', function (event) {
    ...
    saveRow(API_MARCA, action, 'modalForm', 'crudModal');
});
